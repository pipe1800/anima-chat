...
const OnboardingProgressBar = ({ 
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#121212] border-b border-gray-800 p-4">
      {/* Progress Bar */}
      ...
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 bg-gray-800 border-gray-600 text-white hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <Button
          onClick={onNext}
          disabled={!canGoNext}
          className="flex items-center gap-2 bg-[#FF7A00] hover:bg-[#FF7A00]/90 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-[#FF7A00]/25 transition-all duration-300 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Next Step
